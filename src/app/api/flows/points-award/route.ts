...
const FLOW_URL = 'https://2e1e3024670eed439dc2d049ff5827.18.environment.api.powerplatform.com:443/powerautomate/automations/direct/workflows/6e7be96a7ebb4f93a3881c1ce014e01b/triggers/manual/paths/invoke?api-version=1&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=lokD5hsXLHEBDFxyZ0gKy-EEOALMVQfpr8YS-OHEVSA';
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.error('points-award flow error:', err);
