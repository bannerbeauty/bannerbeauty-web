...
const FLOW_URL = 'https://2e1e3024670eed439dc2d049ff5827.18.environment.api.powerplatform.com:443/powerautomate/automations/direct/workflows/d9dd2dceb22f465a901937a33445535c/triggers/manual/paths/invoke?api-version=1&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=UByRRllsEZwW7X4ngYw71UAHOS53O6XWTzmBgOukhSE';
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.error('update-blitz flow error:', err);
