...
const FLOW_URL = 'https://2e1e3024670eed439dc2d049ff5827.18.environment.api.powerplatform.com:443/powerautomate/automations/direct/workflows/03e2f84d8d80459bad485b936531f89e/triggers/manual/paths/invoke?api-version=1&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=h8NhG1IG_oqaC7WceQWJRgnmwAJrjqKtjfAjSWUBLuM';
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.error('points-award-referral flow error:', err);
