...
const FLOW_URL = 'https://2e1e3024670eed439dc2d049ff5827.18.environment.api.powerplatform.com:443/powerautomate/automations/direct/workflows/36224a8789584049a81f40e5e0563d65/triggers/manual/paths/invoke?api-version=1&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=542B5r4I4J2ltW5iZ-Vf4458-unjSSHN8xnpK69yIAU';
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.error('bannerbuddy-action flow error:', err);
